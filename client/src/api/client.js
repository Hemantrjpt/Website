// In local dev, VITE_API_URL is unset, so this stays relative ('/api') and
// goes through Vite's dev proxy to localhost:4000. In production (Vercel),
// set VITE_API_URL to your deployed backend's URL (e.g. https://your-app.wispbyte.app)
// and requests go straight there instead.
const API_URL = import.meta.env.VITE_API_URL || '';
const BASE = `${API_URL}/api`;

// Uploaded images are served by the backend, not the frontend host — this
// turns a stored "/uploads/xyz.png" into the real backend URL in production,
// and leaves it untouched (relying on the dev proxy) locally.

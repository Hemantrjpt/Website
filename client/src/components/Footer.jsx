...
const YouTubeIcon = () => (
  <svg className="discord-icon" viewBox="0 0 24 24" aria-hidden="true" fill="#FF0000">
      ...
      <div className="wrap">
        ...
        <div className="foot-row">
          ...
          <p style={{ display: 'flex', gap: 8 }}>
            {youtubeChannel && (
              <a href={youtubeChannel} className="icon-btn icon-btn-sm" aria-label="YouTube channel" target="_blank" rel="noreferrer">
                <YouTubeIcon />
              </a>
            )}
            <a href={discordInvite} className="icon-btn icon-btn-sm" aria-label="Join Discord">
              <DiscordIcon />
            </a>
          </p>
        </div>
